...
using DropoutCoder.DynamicTypeLinqQuery.Data;
using DropoutCoder.DynamicTypeLinqQuery.Expressions;

namespace DropoutCoder.DynamicTypeLinqQuery {
    class Program {
        static void Main(string[] args) {
            // Array of concrete types assigned to dynamic enumerable
            IEnumerable<dynamic> people = new Person[] {
